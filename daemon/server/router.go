...
import (
	...
	"github.com/networkplayground/common/backend"
	"github.com/networkplayground/common/types"

	"github.com/gorilla/mux"
)

// Router represents the regulus router to send proper HTTP requests to the daemon.
type Router struct {
	*mux.Router
	routes routes
	daemon backend.RegulusDaemonBackend
}

// NewRouter creates and returns a new router for the given backend.
func NewRouter(daemon backend.RegulusDaemonBackend) Router {
